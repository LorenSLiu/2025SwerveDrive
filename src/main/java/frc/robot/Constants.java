...
public final class Constants {
  public static class AutonConstants{
	...
	public static final double X_SETPOINT_REEF_ALIGNMENT = 0.139;  // Vertical pose
	public static final double Y_SETPOINT_REEF_ALIGNMENT = 0.438;  // Horizontal pose //0.331 
