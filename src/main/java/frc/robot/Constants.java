...
//    public static final double ENCODER_TICKS_PER_REV = 2048; // Kraken default
    ...
    // public static final Distance SP_ELEVATOR_SOURCE_DELTA = Inches.of(14.5);
    // public static final Distance ELEVATOR_SOURCE_DELTA = Inches.of(14.5);//check
    // public static final Distance ELEVATOR_BASE_DELTA = Inches.of(0);
    // public static final Distance STAGE_1_HEIGHT_DELTA  = Inches.of(0); 
    // public static final Distance STAGE_2_HEIGHT_DELTA  = Inches.of(10); 
    // public static final Distance STAGE_3_HEIGHT_DELTA  = Inches.of(0);
    ...
    public static final Distance ELEVATOR_SOURCE_DELTA = Inches.of(13.5);//check
